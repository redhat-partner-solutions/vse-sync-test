...
= G.8272 time-error-in-locked-mode system-test-PHC-to-SYS PRTC-B (System-level)

https://www.itu.int/rec/T-REC-G.8272/en[G.8272 Section 6.2] specifies
...
aggregate time error at the system output meets the full PRTC-B requirement.
...
accuracy requirement for https://www.itu.int/rec/T-REC-G.8272/en[PRTC-B].
...
1. Establish normal, locked conditions per
   https://www.itu.int/rec/T-REC-G.8272/en[G.8272 Section 6.2]
