...
= G.8272 time-error-in-locked-mode system-test-PHC-to-SYS PRTC-A (System-level)
...
aggregate time error at the system output meets the full PRTC-A requirement.
...
accuracy requirement for https://www.itu.int/rec/T-REC-G.8272/en[PRTC-A].
