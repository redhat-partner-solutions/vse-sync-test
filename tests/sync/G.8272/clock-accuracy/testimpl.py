...
# Example lines seen in allcaseslogs1.txt for reference:
# I1203 18:06:09.003767   62431 pmc.go:94] pmc -u -b 0 -f /var/run/ptp4l.0.config "SET GRANDMASTER_SETTINGS_NP clockClass              6  clockAccuracy           0x21  offsetScaledLogVariance 0x4e5d  ... timeSource              0x20 "
# GM[1764785098]:[ts2phc.0.config] ens3f0 T-GM-STATUS s0
