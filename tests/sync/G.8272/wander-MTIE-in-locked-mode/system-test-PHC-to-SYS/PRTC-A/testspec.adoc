...
= G.8272 wander-MTIE-in-locked-mode system-test-PHC-to-SYS PRTC-A (System-level)

https://www.itu.int/rec/T-REC-G.8272/en[G.8272 Section 6.2] specifies
requirements on the accuracy of the maximum time interval error (MTIE) for
...
aggregate MTIE at the system output meets the full PRTC-A requirement.
