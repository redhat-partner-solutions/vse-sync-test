...
= G.8272 wander-MTIE-in-locked-mode system-test-PHC-to-SYS PRTC-B (System-level)
...
aggregate MTIE at the system output meets the full PRTC-B requirement.
...
for https://www.itu.int/rec/T-REC-G.8272/en[PRTC-B].
