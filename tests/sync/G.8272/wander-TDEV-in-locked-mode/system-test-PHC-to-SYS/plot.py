...
sync/G.8272/wander-TDEV-in-locked-mode/system-test-PHC-to-SYS
...
from vse_sync_pp.analyzers.phc2sys import TimeDeviationAnalyzer
...
def main():
    ...
    item = {
        'path': output,
        'title': "system-test-PHC-to-SYS TDEV (filtered)",
    }
