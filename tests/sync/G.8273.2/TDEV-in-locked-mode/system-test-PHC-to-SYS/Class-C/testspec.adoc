...
= G.8273.2 TDEV-in-locked-mode system-test-PHC-to-SYS Class-C (System-level)

https://www.itu.int/rec/T-REC-G.8273.2/en[G.8273.2 Section 7.2 Table 7] specifies
requirements on the accuracy of the TDEV for
...
aggregate TDEV at the system output meets the full Class-C requirement.
