...
= G.8273.2 TDEV-in-locked-mode SMA1-to-DPLL Class-C
...
normal, locked operating conditions is not greater than 100% of the overall TDEV requirement for https://www.itu.int/rec/T-REC-G.8273.2/en[Class-C].
