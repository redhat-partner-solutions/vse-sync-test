...
sync/G.8273.2/MTIE-for-LPF-filtered-series/system-test-PHC-to-SYS
...
from vse_sync_pp.analyzers.phc2sys import MaxTimeIntervalErrorAnalyzer
...
def main():
    ...
    item = {
        'path': output,
        'title': "system-test-PHC-to-SYS MTIE (filtered)",
    }
